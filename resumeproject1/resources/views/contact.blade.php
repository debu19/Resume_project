<x-layout>
    ...
    <x-slot name='content'>
        <div class="container mt-5">
            ...
            <div class="row text-white mb-5">
                <p class="mx-auto mb-5">
                    Do you have any questions? Please do not hesitate to contact. I will come back to you within a
                ...
                <div class="col-sm-3 text-center">
                    <ul class="list-unstyled">
                        <li>
                            <i class="fas fa-map-marker-alt mt-4 fa-2x i-color"></i>
                        ...
                        <li>
                            ...
                            <p>debarghyabanerjee19@gmail.com</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="text-center">
            ...
            <a href="#" target="_blank"> <i class="fab fa-discord mx-3 i-color"></i> </a>
        </div>
    </x-slot>
</x-layout>